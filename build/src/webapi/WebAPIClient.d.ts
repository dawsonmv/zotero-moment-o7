...
export declare class WebAPIClient implements ZoteroWebAPI.APIClient {
     ...
     */
    syncArchiveData(_libraryType: string, _libraryId: number, _archives: ZoteroWebAPI.ArchiveData[]): Promise<ZoteroWebAPI.WriteResponse>;
    /**
     * Get archive data from the cloud
     */
    getArchiveData(_libraryType: string, _libraryId: number, _itemKey: string): Promise<ZoteroWebAPI.ArchiveData[]>;
}
