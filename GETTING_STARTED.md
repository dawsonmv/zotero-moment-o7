...
3. In Zotero, go to **Tools → Moment-o7 → Debug Mode** and enable developer logging to see real-time updates
...
├── addon/                 # Zotero addon manifest files
│   ├── bootstrap.js       # Plugin bootstrap
│   ├── manifest.json      # Plugin metadata
│   ├── prefs.js          # Preferences UI
│   └── locale/           # Localization strings
├── tests/                 # Jest unit tests
├── .scaffold/            # BUILD OUTPUT (git-ignored)
│   └── build/
│       └── moment-o-7.xpi  # The compiled plugin
