...
Zotero.MomentoW8.InternetArchiveService = class extends Zotero.MomentoW8.BaseArchiveService {
	constructor() {
		super({
	...
	reloadSettings() {
		this.timeout = Zotero.Prefs.get("extensions.zotero.momentow8.iaTimeout", true) || 120000; // Default: 2 minutes
		this.maxRetries = Zotero.Prefs.get("extensions.zotero.momentow8.iaMaxRetries", true) || 3;
		this.retryDelay = Zotero.Prefs.get("extensions.zotero.momentow8.iaRetryDelay", true) || 5000; // 5 seconds
	}
};