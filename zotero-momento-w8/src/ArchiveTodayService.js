...
Zotero.MomentoW8.ArchiveTodayService = class extends Zotero.MomentoW8.BaseArchiveService {
	constructor() {
		super({
			name: "Archive.today",
			id: "archivetoday",
	...
	async isAvailable() {
		...
		const savedUrl = Zotero.Prefs.get("extensions.zotero.momentow8.archiveTodayWorkerUrl", true);
		if (savedUrl) {
