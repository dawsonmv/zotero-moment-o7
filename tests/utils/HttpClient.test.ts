...
describe("HttpClient", function () {
  ...
  describe("request", function () {
    it("should make successful GET request", async function () {
      const mockResponse = {
        status: 200,
        statusText: "OK",
    ...
    it("should make successful POST request", async function () {
      const mockResponse = {
        status: 201,
        statusText: "Created",
        responseText: '{"id": 123}',
    ...
    it("should handle client errors", async function () {
    ...
    it("should use custom timeout", async function () {
    ...
    it("should handle JSON response type", async function () {
      const mockResponse = {
        status: 200,
        statusText: "OK",
  ...
  describe("header parsing", function () {
    it("should parse headers correctly", async function () {
      const mockResponse = {
        status: 200,
        statusText: "OK",
        responseText: "OK",
    ...
    it("should handle empty headers", async function () {
      const mockResponse = {
        status: 200,
        statusText: "OK",
        responseText: "OK",
