...
describe("ArchiveCoordinator Integration", function () {
  ...
  describe("service registration and discovery", function () {
    ...
    it("should filter available services", async function () {
      const available1 = createMockService("available1", { available: true });
      const unavailable = createMockService("unavailable", {
        available: false,
      });
    ...
    it("should handle service availability errors gracefully", async function () {
  ...
  describe("archive workflow", function () {
    it("should archive using primary service", async function () {
  ...
  describe("service fallback behavior", function () {
    it("should provide services in registration order", function () {
    ...
    it("should allow service replacement", function () {
      const original = createMockService("service", {
        archiveUrl: "https://original.com",
      });
      const replacement = createMockService("service", {
        archiveUrl: "https://replacement.com",
      });
  ...
  describe("concurrent operations", function () {
    it("should handle concurrent availability checks", async function () {
      const services = Array.from({ length: 5 }, (_, i) =>
        createMockService(`service${i}`, {
          available: true,
    ...
    it("should handle concurrent archive operations", async function () {
