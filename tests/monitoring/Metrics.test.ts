...
import {
  ...
  Timer,
  MetricsRegistry,
} from "../../src/modules/monitoring/Metrics";
...
describe("Counter", function () {
  ...
  it("should calculate rate", function () {
...
describe("Gauge", function () {
  ...
  it("should increment by amount", function () {
    gauge.set(10);
    gauge.inc(5);
  ...
  it("should decrement by amount", function () {
    gauge.set(10);
    gauge.dec(3);
    expect(gauge.get()).toBe(7);
  });

  it("should set back to zero", function () {
    gauge.set(100);
    gauge.set(0);
    expect(gauge.get()).toBe(0);
  });
...
describe("Histogram", function () {
  ...
  it("should start with zero count", function () {
  ...
  it("should return 0 for empty mean", function () {
    expect(histogram.getMean()).toBe(0);
  });

  it("should track sum", function () {
  ...
  it("should handle empty percentile", function () {
    expect(histogram.getPercentile(50)).toBe(0);
  });

  it("should track bucket counts", function () {
...
describe("Timer", function () {
  ...
  it("should record duration", function () {
    timer.start("op1");
  ...
  it("should return 0 for unknown operation", function () {
    expect(timer.stop("unknown")).toBe(0);
  });

  it("should time async function", async function () {
  ...
  it("should observe duration directly", function () {
    timer.observe(100);
    timer.observe(200);
  ...
  it("should calculate percentiles via histogram", function () {
...
describe("MetricsRegistry", function () {
  ...
  describe("recordArchive", function () {
    it("should record successful archive", function () {
    ...
    it("should record failed archive", function () {
      registry.recordArchive({
        serviceId: "internetarchive",
        url: "http://example.com",
        success: false,
    ...
    it("should track retries in archive record", function () {
      registry.recordArchive({
        serviceId: "internetarchive",
        url: "http://example.com",
        success: true,
    ...
    it("should track cache hits via fromCache flag", function () {
      registry.recordArchive({
        serviceId: "internetarchive",
        url: "http://example.com",
        success: true,
  ...
  describe("getSnapshot", function () {
    ...
    it("should return overall metrics", function () {
      const snapshot = registry.getSnapshot();
    ...
    it("should calculate average duration", function () {
      const snapshot = registry.getSnapshot();
      expect(snapshot.avgDuration).toBe(3000); // (5000 + 1000 + 3000) / 3
    });
  });

  describe("getServiceMetrics", function () {
    it("should return metrics for specific service", function () {
      registry.recordArchive({
        serviceId: "internetarchive",
        url: "http://example.com",
        success: true,
    ...
    it("should return zero metrics for unknown service", function () {
  ...
  describe("getAggregatedStats", function () {
    it("should return aggregated stats structure", function () {
      registry.recordArchive({
        serviceId: "internetarchive",
        url: "http://example.com",
        success: true,
    ...
    it("should determine correct period label", function () {
      registry.recordArchive({
        serviceId: "internetarchive",
        url: "http://example.com",
        success: true,
    ...
    it("should include proper time range", function () {
