...
export class MementoProtocol {
   ...
   */
  static extractMementoInfo(
    headers: Record<string, string>,
  ): TimeGateResponse | null {
    const linkHeader = headers[this.LINK_HEADER] || headers["link"];
    const mementoDatetime =
      headers[this.MEMENTO_DATETIME_HEADER] || headers["memento-datetime"];
